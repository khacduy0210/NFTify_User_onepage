...
export default function HighlightItem({item}) {
    ...
    return(
        <div className="highlight-item">
            <div className="highlight-image"><img src={item.imageUrl} alt=""/></div>
            <div className="highlight-discription">
                ...
                <div className="highlight-edit">Edition {(item.sellOrder).saleQuantity} of {(item.sellOrder).numberOfCopies}</div>
                <div className="highlight-price">{(item.sellOrder).price} {(item.sellOrder).currencyName}</div>
                <div className="hilight-real-price">~ ${(item.sellOrder).price * (item.sellOrder).exchangeRate}</div>
